...
def make_new_student(first_name, last_name, github):
    ...
    print "Successfully added student: {first} {last}".format(first=first_name, last=last_name)
...
def get_project_by_title(title):
    ...
    print "Project: {title}\nDescription: {description}\nMax Grade: {max_grade}".format(title=row[0],
...
def get_grade_by_github_title(github, title):
    ...
    print "Github: {github}\nProject: {title}\nGrade: {grade}".format(github=row[0], title=row[1], grade=row[2])
